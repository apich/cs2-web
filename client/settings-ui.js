...
export function mountSettings({controls,crosshair,getSettings,onSettings,onEscape}) {
  ...
  modal.addEventListener('keydown',e=>{if(e.code==='Escape'&&!e.defaultPrevented){e.preventDefault();if(onEscape)onEscape();else close();}});
